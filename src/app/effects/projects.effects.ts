...
import { ProjectActionTypes, LoadProjects, ProjectsError, LoadProjectsSuccess } from '../actions/projects.actions';
import { of } from 'rxjs';
...
export class ProjectEffects {
  ...
  loadProjects$ = this.actions$
    .pipe(
      ...
      .pipe(
        map(projectData => {
          return (new LoadProjectsSuccess({projectData: projectData}));
        }),
